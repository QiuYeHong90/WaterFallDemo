...
@class YSHWaterFallyout;

@protocol YSHWaterFallyoutDelegate <NSObject>
 ...
 */
@interface YSHWaterFallyout : UICollectionViewLayout
#pragma mark- 属性
//总共多少列，默认是2
@property (nonatomic, assign) NSInteger columnCount;

//列间距，默认是0
@property (nonatomic, assign) IBInspectable NSInteger columnSpacing;

//行间距，默认是0
@property (nonatomic, assign) IBInspectable NSInteger rowSpacing;

//section与collectionView的间距，默认是（0，0，0，0）
@property (nonatomic, assign) IB_DESIGNABLE UIEdgeInsets sectionInset;
...
//代理，用来计算item的高度
@property (nonatomic, weak) IBOutlet id<YSHWaterFallyoutDelegate> delegate;
